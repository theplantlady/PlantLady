...
import landing from "@/assets/images/hero/hero-landing.jpg"
        ...
        <section className={`pt-[100px]  relative bg-center bg-no-repeat bg-cover`} style={{ backgroundImage: `url(${landing.src})` }}>
            <div className='container-fluid '>
                <div className='pt-[160px] pb-[230px]'>
                    <h1 className='tl:text-[200px] tl:text-[150px] tab:text-[120px] tab:text-[90px] text-[60px] font-extrabold leading-[100%]  text-center text-primary-foreground'>Architecture Interior</h1>
                    <div className='flex tab:flex-row flex-col items-center justify-center gap-5 mt-14'>
