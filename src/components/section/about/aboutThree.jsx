    ...
    return (
        <section className='pt-20'>
            <div className='container-fluid'>
                ...
                <div className={`bg-primary tl:mt-[220px] tab:mt-25 tab:mt-44 mt-[520px] `}>
                    <div className='container'>
                        <div className='flex tab:flex-row flex-col items-center justify-between gap-[66px]'>
                            <div className='tl:-mt-25 tab:mt-4 -mt-[470px]'>
                                <SectionSidebarImg img={about_bg} section_name={"about-bg"}/> 
                            </div>
                            <div className='max-w-[650px] tab:pb-0 pb-10'>
                                <h2 className='text-secondary-foreground tab:text-5xl text-[40px] font-bold leading-120 max-w-[500px]'>Crafting Your Vision: Our Design Process</h2>
                                <ul className='pt-10 '>
                                    {
                                        aboutList.map(({ id, item, item_desc }) => {
                                            return (
                                                <li key={id} className='tab:flex gap-10 pb-10 last:pb-0 justify-between'>
                                                    <svg ref={ref} strokeWidth="1" className={`h-[65px] tl:w-20 w-[250px] relative -top-1 left-0 tl:text-6xl text-5xl mb-3 tab:mb-0 inline-block font-extrabold leading-120 ${inView ? "animate-text-line-animation stroke-secondary stroke-dasharray-1000 stroke-dashoffset-1000" : "fill-transparent stroke-secondary"} `}><text x="0%" dominantBaseline="middle" y="70%">{id}</text></svg>
                                                    <div className='max-w-[520px]'>
                                                        <h4 className='text-3xl ts:text-4xl font-bold leading-135 text-secondary-foreground pb-1.5'>{item}</h4>
