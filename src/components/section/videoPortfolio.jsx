    ...
    return (
        <section className='pt-20'>
            <div className='container-fluid '>
                <SectionTitle
                    sectionName={"3D Visuals"}
                    sectionTitle={"Immersive Plantscape Design"}
                    sectionDesc={"Bringing Concepts to Life with Precision 3D Models for Stunning Interior Greenery"}
                    bg_muted={bg_muted}
                    text_muted={text_muted}
                />
            </div>
            <div className='container-fluid tab:pt-30 ts:pt-20 pt-14'>
                <div className={cn(` relative after:contents-[""] after:absolute after:left-0 after:top-0 after:max-w-[1320px] after:w-full z-[1] after:h-full after:bg-primary ${after_bg_muted} pt-[90px] pb-[110px]`)}>
                    <div className='container flex tab:flex-row flex-col justify-between relative z-10'>
                        <div className='tl:max-w-[637px] tab:max-w-[500px] w-full'>
                            <h4 className='text-secondary-foreground text-3xl ts:text-4xl font-bold leading-135'>Step into the dynamic world of Visual Design Odyssey</h4>
                            ...
                            <Link href={""} className='mt-[70px] inline-block'>
                                <ButtonOutline className={'border-secondary text-secondary-foreground phx:px-10 px-3 after:hover:bg-secondary after:left-0 hover:text-primary-foreground'}>Process of Our Work <RightArrow width={"35"} height={"22"} /></ButtonOutline>
                            </Link>
                        </div>
