...
const TeamCardOne = ({page, img, social_link, name, position, text_muted, cardVariants, prantCalss  }) => {
  return (
    ...
    >
      <div className='relative group hover-underline'>
        ...
        <div className='bg-secondary  absolute left-0 bottom-[-10%] min-w-[295px] transition-all duration-500 group-hover:min-w-full'>
          ...
          <Link href={page} className='flex items-center justify-between px-[27px] pt-[9px] pb-[18px]'>
            <label>
