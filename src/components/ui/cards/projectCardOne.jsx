...
const ProjectCardOne = ({ order, position, project_year, project_desc, project_img, location, project_type, project_name, link, imageVariants, cardVariants }) => {
    return (
        <div className='tl:max-w-[95%] w-full mx-auto relative overflow-hidden '>
            <div className='container'>
                <div className='flex tab:flex-row flex-col items-center tab:pb-[170px] pb-25 '>
                    <div className={`${order} tab:w-1/2 `}>
                        <div className={`${position} w-full tl:max-w-[1100px] max-w-[800px] max-h-[700px] h-full`}>
                            <motion.div
                                initial="offscreen"
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true, amount: 0 }}
                        className='tab:w-1/2 tab:mt-[187px] relative z-[1]'
                    >
                        <div className={`bg-primary tl:px-16 px-8 tl:pt-[78px] pt-10 tl:pb-[58px] pb-7  `}>
                            <h3 className='tl:text-5xl tab:text-[40px] text-4xl font-extrabold leading-120 text-secondary-foreground pb-10'>{project_name}</h3>
