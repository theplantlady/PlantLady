    ...
    return (
        <div className='container'>
            <ul className='flex justify-center'>
                <li className='ts:mr-[22px] mr-1'>
                    <ButtonFill className={"rotate-180 py-[23px] h-[75px] ts:px-6 px-3 after:bg-secondary border-secondary hover:border-primary text-primary-foreground after:left-0"}><RightArrow width={"35"} height={"22"} /></ButtonFill>
                ...
                <li className='ts:ml-[22px] ml-1'>
                    <ButtonFill className={"py-[18px] h-[75px] hover:border-primary ts:px-10 px-4 after:left-0"}> <span className='phx:block hidden'>Next</span> <RightArrow width={"35"} height={"22"} /></ButtonFill>
