...
const BlogSection = ({blogListTitle, blogListSubTitle, blogListText2,blogListText3,blogListText, blogListData}) => {
    return (
        <div className='container flex tab:flex-row flex-col justify-between relative z-10 pt-[23px] mb-[14px]'>
            <div className='tl:max-w-[637px] tab:max-w-[500px] w-full'>
                <h4 className='text-primary-foreground text-3xl ts:text-4xl font-bold leading-135'>{blogListTitle}</h4>
                <h4 className='text-primary-foreground text-2xl ts:text-2xl font-bold leading-135'>{blogListSubTitle}</h4>
