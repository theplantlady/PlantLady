...
const NextPrevPost = ({ link, title, arrowRotate }) => {
    return (
        <div className='flex justify-between tab:items-center tab:flex-row flex-col gap-5 pt-8 tab:pt-0'>
            ...
            <p className='min-h-[77px] h-full w-0.5 bg-primary tab:block hidden'></p>
