            ...
            <div className=' bg-secondary '>
                <div className='container'>
                    <div className='grid lg:grid-cols-3 grid-cols-1 items-center pt-[100px] pb-20'>
                        ...
                        <div className='mt-12 lg:mt-0 flex gap-x-10'>
                            ...
                            <div>
                                ...
                                <div className=''>
                                    <p className='text-xl font-bold text-primary-foreground'>Plant Lady, </p>
                                ...
                                <div className='mt-[17px]'>
                                    ...
                                    <Link href={"mailto:hello@Plant Lady.com"} className='text-lg block text-primary-foreground hover-underline'>Email: <span>hello@Plant Lady.com</span></Link>
                                </div>
                            </div>
                        </div>
                        <div className='mt-12 lg:mt-0 flex gap-x-10'>
                            ...
                            <div>
                                ...
                                <div className='mt-[18px]'>
                                    <p className='text-xl font-bold text-primary-foreground'>Plant Lady Inc, </p>
                    ...
                    <div className='py-8 lg:flex justify-between items-center'>
                        ...
                        <span className='text-sm text-primary-foreground block mt-3 lg:mt-0'>©2024, Plant Lady, All Rights Reserved</span>
                    </div>
                </div>
            </div>
        </footer>
