              ...
              <div className='pt-12.5'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Russell specializes in residential, commercial a outdoor design.</p>
                  </li>
                  <li className='pt-7.5'>
                    <h5 className='font-bold'>Specializations:  </h5>
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>His expertise lies in creating a timeless interiors that seamlessly blend luxury and functionality.</p>
                  </li>
                </ul>
              </div>
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Russell's design philosop Architronix revolves around capturing the essence of each client's persionality and translating it into a space that feels uniquely theirs.</p>
                  </li>
                  <li className='pt-7.5'>
                    <h5 className='font-bold'>Client-Centric Approach: </h5>
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Through close collaboration, Russell ensures that a every design reflects the client's vision and exceeds expectations.</p>
                  </li>
                </ul>
              </div>
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Russell holds a Master's in Interior of the Design from Architronix University of Belgium.</p>
                  </li>
                  <li className='pt-7.5'>
                    <h5 className='font-bold'>Professional Credentials:    </h5>
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Recognized as an the industry leader, Russell is a member of the National Interior Design for Association (NIDA) and has received accolades for his innovative designs.</p>
                  </li>
                </ul>
              </div>
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 tl:ml-[113px] ts:ml-14 ml-10'>Russell Otten's work at Architronix has been feeatured in Design Excellence Magazine, earning him the Interior Alchemist title.</p>
                  </li>
