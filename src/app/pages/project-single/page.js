...
import bg_banner from "@/assets/images/projects/project-hero-image.jpg"
import project_img_1 from "@/assets/images/projects/project-image-1.jpg"
import project_img_2 from "@/assets/images/projects/project-image-2.jpg"
                    ...
                    <div className='container ts:mt-[156px] phx:mt-30 mt-20'>
                        <div className='grid tab:grid-cols-[65%_auto] gap-[38px]'>
                            <div className='relative after:absolute phx:after:-left-12.5 after:-left-5 after:top-1/2 after:-translate-y-1/2 after:w-[1px] phx:after:h-[130%] after:h-[120%] after:bg-primary phx:ml-12.5 ml-5'>
                                ...
                                <p className='text-2xl phx:text-3xl ts:text-4xl !leading-160 text-primary-foreground mt-[18px]'>The design of this apartment facing Ipanema beach, in Rio de Janeiro, was designed for a couple with two young children, who wanted a space to accompany their daughters' growth and also environments with privacy for home office work.</p>
                            </div>
