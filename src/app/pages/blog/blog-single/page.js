...
import blog_single_image from "@/assets/images/blog/blog-single-image.jpg"
import blog_inner_img from "@/assets/images/blog/blog-inner-image.jpg"
...
const BlogSingle = () => {
    ...
    return (
        <>
            <section className=''>
                <div className='object-cover bg-no-repeat tl:pt-[448px] tl:pt-[300px] tab:pt-[200px] pt-[150px] pb-[68px] relative z-[1] after:contents-[""] after:z-[-1] after:absolute after:left-0 after:bottom-0 after:w-full after:h-full after:bg-bottom-liner' style={{ backgroundImage: `url(${blog_single_image.src})` }}>
                    <div className='container '>
                        ...
                        <p className='mt-14 text-secondary-foreground flex phx:gap-[9px] gap-[1px]'> <span>15 November ‘23</span>  / <span>Interior</span> / <span>5 min read</span> </p>
                    </div>
                </div>
                    ...
                    <div className='grid tl:grid-cols-[auto_427px] tab:grid-cols-[auto_400px] tl:gap-[130px] tab:gap-16 items-start'>
                        ...
                        <div>
                            <div>
                                ...
                                <h3 className='text-3xl ts:text-4xl font-bold text-primary-foreground leading-135 pt-[23px] mb-[14px]'>Embrace Minimaliphx:</h3>
                            ...
                            <div>
                                <h3 className='text-3xl ts:text-4xl font-bold text-primary-foreground leading-135 pt-[23px] mb-[14px]'>Multi-Functional Furniture:</h3>
                            ...
                            <div>
                                <h3 className='text-3xl ts:text-4xl font-bold text-primary-foreground leading-135 pt-[23px] mb-[14px]'>Vertical Storage Solutions:</h3>
                                <p className='text-primary-foreground'>In a smaller living space, less is often more. Embrace minimalism by selecting furniture with clean lines, uncluttered surfaces, and a neutral color palette. A minimalist to approach not only creates a sleek and open environment but also instills an sense of calm and tranquility in your apartment.</p>
                            ...
                            <div>
                                <h3 className='text-3xl ts:text-4xl font-bold text-primary-foreground leading-135 pt-12.5 mb-[14px]'>Use Light Colors:</h3>
                                <p className='text-primary-foreground '>In a smaller living space, less is often more. Embrace minimalism by selecting furniture with clean lines, uncluttered surfaces, and a neutral color palette. A minimalist to approach not only creates a sleek and open environment but also instills an sense of calm and tranquility in your apartment.</p>
                            </div>

                            <div>
                                <h3 className='text-3xl ts:text-4xl font-bold text-primary-foreground leading-135 pt-[54px] mb-[14px]'>Smart Storage Solutions:</h3>
                                <p className='text-primary-foreground '>In a smaller living space, less is often more. Embrace minimalism by selecting furniture with clean lines, uncluttered surfaces, and a neutral color palette. A minimalist to approach not only creates a sleek and open environment but also instills an sense of calm and tranquility in your apartment.</p>
                                <p className='text-primary-foreground pt-[18px]'>In a smaller living space, less is often more. Embrace minimalism by selecting furniture with clean lines, uncluttered surfaces, and a neutral color palette. A minimalist to approach not only creates a sleek and open environment but also instills an sense of calm and tranquility in your apartment.</p>
                            </div>
                            ...
                            <div className='pt-[54px] flex gap-3 flex-wrap'>
                                {
                                    tagList.map(({ id, link, tag }) => {
                                        return (
                                            <Link href={""} key={id}>
                                                <ButtonOutline className={"font-normal px-2.5 phx:py-[5px] py-[5px] border"}> <span className='text-lg'>{tag}</span> </ButtonOutline>
                                            </Link>
                                        )
                                    })
                                }
